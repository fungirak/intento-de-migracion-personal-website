...
<h6 className="text-center">©  FUNGIRAK.COM</h6>
      </p>
    </div>
  </div>
      </>
      ...
      <div className="w-100 fixed-bottom">
        <div className="pink lighten-2  fs-6 fw-bold text-center text-white">{banda}</div>
      </div>
  </div>;
};
